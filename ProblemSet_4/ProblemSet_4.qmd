...
ggplot(artsales, aes(x = Genre___Photography, 
                     y = medianprice_year)) +
  geom_count() + ggtitle("Photography")

mod1 <- lm(medianprice_year ~ as.factor(Genre___Photography) +
             as.factor(Genre___Print) + as.factor(Genre___Sculpture) +
             as.factor(Genre___Painting) + as.factor(Genre___Others),
           data=artsales)
summary(mod1)
